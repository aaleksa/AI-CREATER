...
Image / Post: idea → visuals (4 stills з брифу). Invite — ще compose флаєра. `PATCH /projects/:id/invite` — 0 cr.

| step | credits | Що вважається успіхом |
| --- | --- | --- |
| idea | 5 | `idea_json` |
| script | 10 | `script_json` (лише відео) |
| visuals | 40 max / **32 max** на пост | кадри; live × 8; поріг ≥3/5 відео або ≥3/4 пост |
